...
<div class="container">
	...
	<?php
		...
		{
			echo '<div class="alert alert-primary" role="alert"><b>' . '<a href="adminBillet.php?goto='. $carnet['id'] .'" class="btn btn-danger">consulter carnet</a>' . '</b> ' . $carnet['lieu'] . '</b> ' .$carnet['description'] . '<a href="admin.php?suppr=' . $carnet['id'] .'" class="btn btn-danger">X</a></div>';
		}
	?>
